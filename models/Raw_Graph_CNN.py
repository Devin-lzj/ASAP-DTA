...
#
# This is the implementation for the ASAP-DTA of RAW architecture, i.e., ASAP-DTA(NO Pool).
#
...
class Raw_graph_cnn(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128, num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.1):
        ...
        # self.pool1 = ASAPooling(in_channels=3*num_features_xd, ratio=self.pooling_ratio, GNN=LEConv)

        self.fc_g1 = torch.nn.Linear(2*num_features_xd, output_dim)  # 1024
